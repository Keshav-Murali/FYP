...
int main()
{
  ...
  std::cout << "Time to generate 10^8 numbers for Xorshift: " << ms_double.count() << "ms\n";
  ...
  ms_double = t2 - t1;
  std::cout << "Time to generate 10^8 fractions for Xorshift: " << ms_double.count() << "ms\n";
