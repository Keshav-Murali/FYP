...
int main()
{
  ...
  std::cout << "Parameters: " << g1.state << " " << g1.c << std::endl;
  ...
  std::cout << "Time to generate 10^8 numbers for MWCG: " << ms_double.count() << "ms\n";
  ...
  ms_double = t2 - t1;
  std::cout << "Time to generate 10^8 fractions for MWCG: " << ms_double.count() << "ms\n";
